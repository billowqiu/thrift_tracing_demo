...
//  public static Calculator.Processor processor;
  ...
  public static void main(String [] args) {
    ...
    try {
      ...
      final TProcessor spanProcessor = new SpanProcessor(processor, tracer);
  ...
  public static void secure(TProcessor processor) {
    try {
      /*
       ...
       */
      TServerTransport serverTransport = TSSLTransportFactory.getServerSocket(19091, 0, null, params);
      TServer server = new TSimpleServer(new Args(serverTransport).processor(processor));
